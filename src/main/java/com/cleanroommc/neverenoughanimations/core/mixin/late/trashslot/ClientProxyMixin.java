package com.cleanroommc.neverenoughanimations.core.mixin.late.trashslot;
/*
 ...
 * at = @At(value = "INVOKE", target = "Lnet/blay09/mods/trashslot/client/gui/GuiTrashSlot;update(II)V", shift =
 * At.Shift.BEFORE))
 ...
 * }
 * @Inject(method = "onDrawScreen(Lnet/minecraftforge/client/event/GuiScreenEvent$DrawScreenEvent$Pre;)V", at
 * = @At("TAIL"))
 * public void onDrawScreenPost(GuiScreenEvent.DrawScreenEvent.Pre event, CallbackInfo ci) {
 * GlStateManager.popMatrix();
 * }
 * @Inject(method = "onBackgroundDrawn", at = @At(value = "INVOKE", target =
 * "Lnet/minecraft/client/gui/inventory/GuiContainer;drawSlot(Lnet/minecraft/inventory/Slot;)V", shift =
 * At.Shift.BEFORE))
