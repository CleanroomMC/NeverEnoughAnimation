 ...
 * It is automatically implemented for every {@link net.minecraft.client.gui.inventory.GuiContainer GuiContainer}. If
 * you implemented it
 * manually on your {@link net.minecraft.client.gui.GuiScreen GuiScreen} you will need to call
 * {@link com.cleanroommc.neverenoughanimations.animations.OpeningAnimation#handleScale(GuiScreen, boolean)
 * OpeningAnimation#handleScale(GuiScreen, boolean)}
 * yourself right after you rendered any background which covers the whole screen (since you don't want it to scale) and
 * right before you
 * draw the screen.
 */
